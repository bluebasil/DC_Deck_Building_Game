...
class player:
    ...
    # Important links
    controler: controlers.controler = None
    persona: persona_frame.persona = None

    # Note: I would like to rework the  'redirect' functionality
    # Cards or personas can register recitations here
    ...
    def play_and_return(self, card, pile=None):
        ...
        self.played.play(card)
        card.pop_self()
        # gets put back at the location specified, no matter what
    ...
    def gain(self, card: card_frame.card, price: int = None, defeat: bool = False):
        bought = False
        ...
        # Right now I will have both features until I patch the other sets
        redirected = False
